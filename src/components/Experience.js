  ...
  return (
    <div>
        <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center" px={{base: '1rem', sm: '2rem', lg:'10rem'}} py={{base: '1rem', sm: '2rem', lg: '5rem'}} bg="#dbe2ef" color="#112D4E">
            <Text className="section-title" textAlign="center" fontSize="5xl" fontWeight="600" mb="0.5rem">EXPERIENCE</Text>
            <Text mb="3rem" textAlign="center" fontSize="2xl" fontWeight="300">Career path</Text>
            <Box>
              <Grid
                h="200px"
